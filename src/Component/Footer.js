        ...
        <footer className=" bg-gradient-to-b from-black to-gray-800 text-center text-white ">
            <div className="container px-6  mx-auto pt-40 ">
                <div className="mb-6 flex justify-center w-full">
                    ...
                    <div className="light">
                        <a
                            href="mailto:sumitsuyal316@gmail.com@gmail.com" target="_blank" rel="noopener noreferrer"
                            type="button"
                    ...
                    <div className="light">
                        <a
                            href="https://www.linkedin.com/in/sumit-suyal-0bb133208/" target="_blank" rel="noopener noreferrer"
                            type="button"
                            className="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                        >
                               <svg
                    ...
                    <div className="light">
                        <a
                            href="https://github.com/SumitSuyal" target="_blank" rel="noopener noreferrer"
                            type="button"
                            className="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                        ><svg
                        xmlns="http://www.w3.org/2000/svg"
